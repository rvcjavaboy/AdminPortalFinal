...
<!-- heading -->
			...
			%>
			<form id="formProfile" method="post" name="Profile"
				action="changepasswordServ" class="form-horizontal" role="form">

				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-2"> User Name </label>

					<div class="col-sm-9">
						<input type="text" value="<%=session.getAttribute("uname")%>"
							name="firstname" id="firstname" placeholder="UserName"
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-2"> Current Password </label>
